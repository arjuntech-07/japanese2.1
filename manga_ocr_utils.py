...
GGUF_PATH = "/kaggle/input/models-for-manga/Qwen3-VL-8B-Instruct-abliterated-v2.0.Q8_0.gguf"
...
def load_ocr_model():
    ...
    # Run the setup first to ensure the model exists in Ollama's registry
